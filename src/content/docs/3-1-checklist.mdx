...
* pour trouver des notebooks dans le cours d'intro, regarder dans `demo/notebooks`  
 (car le corps du cours n'est plus écrit en notebooks...)
* et bien sûr il faut remplacer les noms comme `ue12-p22` en `ue12-p26`, comme vous allez le deviner
</Admonition>
...
* de cloner les supports de cours qui sont ici  
  [https://github.com/ue12-p26/intro](https://github.com/ue12-p26/intro)

* d'ouvrir sous jupyter les notebooks dans le dossier `demo/noteboks`
