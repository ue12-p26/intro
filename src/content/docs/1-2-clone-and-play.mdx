...
vous aurez copié **dans votre presse-papier la chaine `git@github.com:ue12-p26/intro.git`**  
...
git clone # ... et ici vous collez le presse-papier
          # ... ce qui donne
git clone git@github.com:ue12-p26/intro.git
```
...
git clone git@github.com:ue12-p26/intro.git installations
```
</Admonition>
