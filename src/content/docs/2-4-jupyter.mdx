...
sont aussi très pratiques dans la vraie vie - et particulièrement pour le cours de numérique !
...
si vous êtes en train de lire un cours que vous avez cloné depuis github, et
**si celui-ci contient un fichier `requirements.txt`**, alors tapez également cette
commande
...
* ouvrir un des notebooks du repo (dans le dossier `demo/notebooks` du repo `intro`, dans le dossier `notebooks` du repo `numerique`)  
