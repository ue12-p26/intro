...
2. un module d'**apprentissage de la programmation**
   * vous choisissez **un langage** <LabeledLink label="label-proposed-languages" file="0-2-presentation-longue">parmi la liste qui est donnée dans la présentation détaillée</LabeledLink>
   * le cursus est sur 9 séances quel que soit le langage choisi
   * plus une séance de hackathon d'une journée en fin de trimestre (coder en équipe)
